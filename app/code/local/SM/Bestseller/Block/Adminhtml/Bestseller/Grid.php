...
class SM_Bestseller_Block_Adminhtml_Bestseller_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
...
//  {
//      $collection = Mage::getModel('bestseller/megamenu')->getCollection();
