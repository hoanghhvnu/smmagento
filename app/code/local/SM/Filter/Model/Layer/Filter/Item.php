...
class SM_Filter_Model_Layer_Filter_Item extends Mage_Catalog_Model_Layer_Filter_Item
{
    ...
    public function getUrl()
    {
        ...
        if ($currentFilter == NULL) {
            $addString = $this->getValue();
        } elseif (in_array($this->getValue(), explode('_', $currentFilter))){
            $addString = $currentFilter;
        } else {
            $addString = $currentFilter . '_' . $this->getValue();
        }

        $query = array(
            $this->getFilter()->getRequestVar()=>$addString,
